...
namespace UserActor
{
    ...
    internal class UserActor : Actor, IUserActor
    {
        ...
        {
            await StateManager.AddOrUpdateStateAsync(cartItem.ProductId.ToString(), cartItem.Quantity, (productid, oldquantity) => oldquantity + cartItem.Quantity);
        }

        public async  Task ClearCart()
        {
          
            var productIDList = await StateManager.GetStateNamesAsync();
